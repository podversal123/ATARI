...
export type BulkDownloadMode = "selected-records" | "selected-kvks-category" | "all-images";

export const BULK_DOWNLOAD_OPTIONS: { mode: BulkDownloadMode; label: string; description: string }[] = [
  {
  ...
  },
  {
    ...
    description: "Download every photograph for the selected KVKs and category.",
  },
  {
    mode: "all-images",
    label: "All Images (All Categories)",
    description: "Download all images for the selected filters, grouped by category.",
  },
];
