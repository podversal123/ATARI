...
const MODEL_FIELDS: Record<string, string[]> = {
  ...
  oft: ["reportingYear", "discipline", "thematicArea", "trialOnForm", "status", "quantity", "unit", "costOfOft", "fundingAgency"],
  fld: ["reportingYear", "category", "subCategory", "technologyDemonstrated", "status"],
  ...
  poshanMaaha: ["activityDate", "activitiesConducted", "eventName", "saplingsPlanted", "vegetableKits", "totalParticipants"],
  ...
  nfSoilData: ["season", "type", "crop", "beforePh", "beforeEc", "afterPh", "afterEc"],
  nfBudgetExpenditure: ["activityName", "activitiesOrganised", "budgetSanction", "budgetExpenditure"],
  subPlanActivity: ["activities", "noOfTraining", "beneficiaries"],
  ...
  digitalKmas: ["farmersCovered", "advisoriesSent", "messagesCrop", "messagesLivestock", "messagesWeather", "messagesMarketing"],
  digitalOtherChannel: ["textAdvisories", "textFarmers", "whatsappAdvisories", "whatsappFarmers", "socialMediaAdvisories", "socialMediaFarmers"],
  sacMeeting: ["startDate", "endDate", "participants", "statutoryMembers", "recommendations", "actionTaken"],
