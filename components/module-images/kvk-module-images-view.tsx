...
import { MODULE_IMAGE_REPORTING_YEARS, MODULE_IMAGE_ROWS } from "@/lib/module-images";
...
export function KvkModuleImagesView() {
  ...
  const filteredRows = useMemo(() => {
    ...
    return MODULE_IMAGE_ROWS.filter((row) => {
      ...
      if (query && !(row.categoryLabel.toLowerCase().includes(query) || row.caption.toLowerCase().includes(query))) {
        return false;
      }
      return true;
    });
  }, [currentKvkName, reportingYear, categoryPath, fromDate, toDate, search]);

  const hasActiveFilters = categoryPath !== ALL_CATEGORIES || fromDate !== "" || toDate !== "";
    ...
    <div className="space-y-4">
      <div className="rounded-lg border border-border bg-card p-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/module-images/add-image" className={cn(buttonVariants({ size: "sm" }))}>
      ...
      <div className="rounded-lg border border-border bg-card">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border p-4">
          <p className="text-sm font-semibold text-foreground">Your Uploaded Images ({filteredRows.length})</p>
                ...
                <tr>
                  <td colSpan={6} className="px-4 py-16 text-center text-muted-foreground">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <Link href="/module-images/add-image" className="text-xs font-medium text-primary hover:underline">
